...
void main(){
 ...
 print("QUESTION NO.3");
  int num11 = 16;
  int num22 = 10;
  print('TOTAL NUMBER OF CLASSES = $num11');
  print('NUMBER OF CLASSES ATTENDED = $num22');
  var percentage09 = ((num22/ num11) *100);
  print ('PERCENTAGE OF CLASSES ATTENDED = $percentage09 %');
  if (percentage09>=75){
 ...
 print("QUESTION NO.4");
  int num33 = 15;
  print ('CELSIUS = $num33 °C');
  var num44 = ((num33* (9/5)+35));
         print('FARHENHEIT = $num44 °F');
...
print("It's Very Hot");
 ...
 print("QUESTION NO.8");
  ...
  int obtainedmarks12= sub1+ sub2+sub3+sub4+sub5;
  print('Obtained marks = $obtainedmarks12');
  int totalmarks22= 500;
  var percentage1=((obtainedmarks12/totalmarks22)*100);
  if(percentage1>100){
   print('INVALID');
  }else if(percentage1>= 40 &&percentage1<=100){
